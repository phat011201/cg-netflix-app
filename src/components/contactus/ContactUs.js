...
import { faArrowRight, faBan, faBarsStaggered, faCaretDown, faCreditCard, faEnvelope, faLock } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className={cx('wrapper')}>
            <div className={cx('header-wrapper')}>
                <div className={cx('header')}>
                    ...
                    <div className={cx('right-header')}>
                        <button className={cx('btn','btn-text')} onClick={navigate('/register')}>
                            Tham gia netflix
                        </button>
                        <button className={cx('btn','btn-primary')} onClick={()=>navigate('/login')}>
                            Đăng nhập
                        </button>
                    </div>)
                    :
            ...
            <div className={cx('content')}>
                ...
                <div className={cx('description-problem')}>
                    <p className={cx('lable-input')}>Hãy chia sẻ thêm và chúng tôi sẽ tìm giải pháp tốt nhất cho bạn</p>
                    <div className={cx('wrapper-input')}>
                        <input  placeholder="Mô tả sự cố của bạn" className={cx('input')}/>
